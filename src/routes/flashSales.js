...
// CRITICAL: Specific named routes MUST come BEFORE parameterized routes
router.get("/active", flashSalesController.getActiveFlashSales);
router.get("/upcoming", flashSalesController.getUpcomingFlashSales);

// CRITICAL: /product/:productId/all MUST come BEFORE /product/:productId
router.get(
  "/product/:productId/all",
  flashSalesController.getAllFlashSalesByProductId,
);
